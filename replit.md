...
## Recent Changes
- Feb 08, 2026: Enhanced Service schema with SERVICES_CATALOG (3 categories: Home Inspector, Environmental Consultant, Water Damage Restoration Service), added description, serviceType, and category fields to all 22 services under hasOfferCatalog; exported ServiceItem, ServiceCategory types and ALL_SERVICES helper
