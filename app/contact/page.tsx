      ...
      <nav className="bg-gray-100 py-3">
        <div className="max-w-6xl mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-ocean-700 font-medium">Contact</li>
          </ol>
        </div>
      </nav>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:9493715934" className="text-ocean-600 text-lg hover:text-ocean-700">949-371-5934</a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@ocmoldpros.com" className="text-ocean-600 text-lg hover:text-ocean-700">info@ocmoldpros.com</a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <Link href="/service-areas" className="text-ocean-600 text-sm hover:text-ocean-700">View all service areas →</Link>
                  </div>
                </div>
              </div>
