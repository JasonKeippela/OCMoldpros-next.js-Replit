        ...
        <section className="py-16 bg-gradient-to-b from-ocean-50 to-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mb-8 rounded-lg overflow-hidden shadow-lg">
              <Image 
                src="/images/dana-point-harbor.png" 
                alt="Dana Point Harbor with sailboats, coastal bluffs, and palm trees overlooking the Pacific Ocean" 
                width={1024}
                height={576}
                priority
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Not sure if we cover your area? If you&apos;re in Dana Point, we can help. DM or call to schedule a free 20-minute consultation.
            </p>
          </div>
        </section>
