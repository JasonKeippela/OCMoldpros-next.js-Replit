...
export default function HuntingtonBeachPage() {
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    "name": "OC Mold Pros",
    "description": "Professional mold inspection and testing services in Huntington Beach, CA",
    "url": "https://ocmoldpros.com/mold-inspector-near-me/huntington-beach-ca",
