      ...
      <main className="pt-28">
        ...
        <section className="py-16 bg-gradient-to-b from-ocean-50 to-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-lg text-gray-600 mb-6 max-w-3xl">
              What truly sets San Clemente apart, however, is its surf culture. Just south of town, <a href="https://www.sanclementeguide.com/surfing-in-san-clemente-ca" target="_blank" rel="noopener noreferrer" className="text-ocean-600 hover:text-ocean-700 underline font-medium">Trestles is one of the most respected surf breaks in the world</a> and will host Olympic surfing during the 2028 Summer Olympics which is a massive recognition of the area&apos;s wave quality and consistency. Combined with iconic spots like T-Street and San Onofre, plus the scenic 2.3-mile beach trail connecting the coastline, San Clemente offers a lifestyle centered around the ocean, outdoor activity, and community pride.
            </p>
